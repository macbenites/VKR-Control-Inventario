...
<sql:query var="sqlrIngreso" dataSource="jdbc/calprusof">
    select T1.id_salida,T1.fecha_salida,T2.nom_emp,T3.nom_cliente
    from salidap T1
    inner join empleado T2 on T2.id_empleado=T1.id_usuario
    inner join clientes T3 on T3.id_clientes=T1.id_cliente
    ORDER BY T1.id_salida ASC;
</sql:query>
            ...
            <div class="content-wrapper">
                <div class="content">
                    <section class="content-header">
                        <div class="row">
                            <div class="col">
                                <h1>Lista de Registro de Salida</h1>
                            </div>
                        </div>
                    </section>
                    <table id="datos" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Codigo</th><th>Fecha de Salida</th><th>Cliente</th><th>Responsable</th><th colspan="2"><input size=10 type="text" name="table_search" id="searchTerm" onkeyup="doSearch()" class="form-control float-right" placeholder="Buscar"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach var="i" items="${sqlrIngreso.rows}">
                                <tr>
                                    ...
                                    <td>${i.nom_emp}</td>
                                    <td>
                                        <button type="button" class="btn btn-block btn-info btn-sm" onclick="Ver(${i.id_salida})">Ver</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                ...
                <!--Ventana Emergente 1-->
                <div class="modal fade" id="VerSalida">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input type="hidden" readonly=»readonly» class="form-control" id="txtCodigo">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" method="POST" >
                                            ...
                                            <table class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th>#</th><th>NOMBRE</th><th>DESCRIPCION</th><th>CANTIDAD</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="detalle">
                                                </tbody>
