...
<sql:query var="sqliemp" dataSource="jdbc/calprusof">
    select max(id_clientes)as id_clientes from clientes
</sql:query>
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <title>VKR | Registro Cliente</title>
        ...
        <script type="text/javascript">
            ...
            function Guardar() {
                ...
                datos = {codigo: cod, nombre: nom, dni: dni, dep: dep, pro: pro, dis: dis, direccion: dir, telefono: tel};
                $.ajax({
                    data: datos,
                    type: 'POST',
                    url: "RegistrarCli.jsp",
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <c:forEach var="i" items="${sqliemp.rows}">
                                        <div class="2">
                                            <button type="button" class="btn btn-info" onclick="TraerCodigo(${i.id_clientes+1})">Generar Codigo</button>
                                        </div>
                                    </c:forEach>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="txtDNA" class="col-sm-2 col-form-label">DNI *</label>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control obligatorio" id="txtDNI" placeholder="DNI">
                                    </div>
                                </div>
                                <div class="form-group row">
