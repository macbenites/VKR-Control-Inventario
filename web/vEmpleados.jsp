...
<sql:query var="sqlempleados" dataSource="jdbc/calprusof">
    select T1.id_empleado,T1.nom_emp,T1.apepat_emp,T1.apemat_emp,T1.dni_emp,T2.IdDepartamento,T2.Departamento,T3.IdProvincia,T3.Provincia,T4.IdDistritos,T4.Distrito,T1.dir_emp,T1.tel_emp
    from empleado T1
...
<html lang="en">
    <head>
        ...
        <title>VKR | Lista de Empleados</title>
        ...
        <script src="js/vEmpleado.js"></script>        
        <script>
            function Editar(cod, nom, ap, am, dni, dep, pro, dis, dir, tel) {
                document.getElementById("titulomodal").innerHTML = "Empleado: " + nom;
                document.getElementById("textoGuardar").innerHTML = "Actualizar Empleado";
                document.getElementById("txtCodigo").value = cod;
                document.getElementById("txtNombre").value = nom;
                document.getElementById("txtApePat").value = ap;
                document.getElementById("txtApeMat").value = am;
            ...
            function Eliminar(cod, nom, ap, am, dni, dep, pro, dis, dir, tel) {
                document.getElementById("titulomodal").innerHTML = "Eliminar Empleado: " + nom;
                document.getElementById("textoGuardar").innerHTML = "Eliminar Empleado";
                document.getElementById("txtCodigo").value = cod;
                document.getElementById("txtNombre").value = nom;
                document.getElementById("txtApePat").value = ap;
                document.getElementById("txtApeMat").value = am;
            ...
            function Guardarr() {
                ...
                datos = {codigo: cod, nombre: nom, apepat: ap, apemat: am, dni: dni, dep: dep, pro: pro, dis: dis, dir: dir, tel: tel, opc: op};
                $.ajax({
                    data: datos,
                    type: 'POST',
                    url: "MantenimientovE.jsp",
            ...
            <div class="content-wrapper">
                <div class="content">
                    ...
                    <table id="datos" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Codigo</th><th>Nombre</th><th>Apellido Paterno</th><th>Apellido Materno</th><th>DNI</th><th>Departamento</th><th>Provincia</th><th>Distrito</th><th>Direccion</th><th>Telefono</th><th colspan="2"><input size=10 type="text" name="table_search" id="searchTerm" onkeyup="doSearch()" class="form-control float-right" placeholder="Buscar"></th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach var="i" items="${sqlempleados.rows}">
                                <tr>
                                    <td>${i.id_empleado}</td>
                                    <td>${i.nom_emp}</td>
                                    <td>${i.apepat_emp}</td>
                                    ...
                                    <td>${i.tel_emp}</td>
                                    <td>
                                        <button type="button" class="btn btn-block btn-info btn-sm" onclick="Editar(${i.id_empleado}, '${i.nom_emp}', '${i.apepat_emp}', '${i.apemat_emp}',${i.dni_emp}, '${i.IdDepartamento}', '${i.IdProvincia}', '${i.IdDistritos}', '${i.dir_emp}',${i.tel_emp})">Editar</button>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-block btn-warning btn-sm" onclick="Eliminar(${i.id_empleado}, '${i.nom_emp}', '${i.apepat_emp}', '${i.apemat_emp}',${i.dni_emp}, '${i.IdDepartamento}', '${i.IdProvincia}', '${i.IdDistritos}', '${i.dir_emp}',${i.tel_emp})">Eliminar</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                ...
                <div class="modal fade" id="modal-datos">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control obligatorio" id="txtNombre" placeholder="Ingrese Nombre" pattern="[A-Za-z]" title="Three letter country code">
                                </div>
                                <div class="form-group">
                                    <label for="txtApePat">Apellido Paterno</label>
                                    <input type="text" class="form-control obligatorio" id="txtApePat" placeholder="Ingrese Apellido Paterno">
                                </div>
                                <div class="form-group">
                                    <label for="txtApeMat">Apellido Materno</label>
                                    <input type="text" class="form-control obligatorio" id="txtApeMat" placeholder="Ingrese Apellido Materno">
                                </div>
                                <div class="form-group">
                                    <label for="txtDNI">DNI</label>
                                    <input type="number" class="form-control obligatorio" id="txtDNI" placeholder="Ingrese DNI">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control obligatorio" id="txtDireccion" placeholder="Ingrese Distrito">
                    </div>
                    <div class="form-group">
                        <label for="txtTelefono">Telefono</label>
                        <input type="number" class="form-control obligatorio" id="txtTelefono" placeholder="Ingrese Telefono">
                    </div>
