...
<sql:query var="sqlidpro" dataSource="jdbc/calprusof">
    select max(id_proveedor)as id_proveedor from proveedores
</sql:query>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>VKR | Registro Proveedor</title>
        ...
        <script>
            ...
            function Guardar() {
                ...
                datos = {codigo: cod, razonso: raz, ruc: ruc, dep: dep, pro: pro, dis: dis, direccion: dir, telefono: tele};
                $.ajax({
                    data: datos,
                    type: 'POST',
                    url: "RegistrarProvee.jsp",
                    success: function (data) {
                        alert("REGISTRADO CORRECTAMENTE");
                        location.reload();
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        alert('Error : RUC duplicado');
                    }
                });
            }
        </script>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <c:forEach var="i" items="${sqlidpro.rows}">
                                        <div class="2">
                                            <button type="button" class="btn btn-info" onclick="TraerCodigo(${i.id_proveedor+1})">Generar Codigo</button>
                                        </div>
                                    </c:forEach>
                                </div>
                                <div class="form-group row">
                                    <label for="txtRazonSocial" class="col-sm-2 col-form-label">Razón Social *</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control obligatorio" id="txtRazonSocial" placeholder="Razón Social">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="txtRuc" class="col-sm-2 col-form-label">R.U.C. *</label>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control obligatorio" id="txtRuc" placeholder="R.U.C.">
                                    </div>
                                </div>
                                <div class="form-group row">
