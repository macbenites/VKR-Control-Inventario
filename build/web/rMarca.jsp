...
<sql:query var="sqlidmarca" dataSource="jdbc/calprusof">
    select max(id_marca)as id_marca from marca
</sql:query>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>VKR | Registro Marca</title>
        ...
        <script>
            ...
            function Guardar() {
                ...
                datos = {codigo: cod, nombre: nom, proce: pro};
                $.ajax({
                    data: datos,
                    type: 'POST',
                    url: "RegistrarMa.jsp",
                        ...
                        <form id="quickForm" class="form-horizontal" >
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <c:forEach var="i" items="${sqlidmarca.rows}">
                                        <div class="2">
                                            <button type="button" class="btn btn-info" onclick="TraerCodigo(${i.id_marca+1})">Generar Codigo</button>
                                        </div>
                                    </c:forEach>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="Nombre" class="form-control obligatorio" id="txtNombre" placeholder="Nombre">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="txtProcedencia" class="col-sm-2 col-form-label">Procedencia *</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="Procedencia" class="form-control obligatorio" id="txtProcedencia" placeholder="Procedencia">
                                    </div>
                                </div>
